...
namespace MetaMood.Services
{
    public class AllMappersProfile : Profile
    {
        ...
        public AllMappersProfile()
        {
            ...
            CreateMap<TrackAudioFeatures, SpotifyAnalysisDTO>();
            CreateMap<SpotifyAnalysisDTO, TrackAudioFeatures>().ForMember(t => t.TrackId, opt => opt.Ignore())
                                                      ...
                                                      .ForMember(t => t.Loudness, opt => opt.Ignore())
                                                      .ForMember(t => t.Speechiness, opt => opt.MapFrom(src => src.Speechiness))
                                                      .ForMember(t => t.Tempo, opt => opt.Ignore())
